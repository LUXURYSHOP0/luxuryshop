                    ...
                    <li class="nav-item align-self-center ms-lg-3">
                        ...
                        <li class="nav-item align-self-center ms-lg-3">
                            <a class="nav-link underline-active align-self-center text-main" aria-current="page"
                                href="https://discord.gg/tsUNzKh3Md"><img src="assets/icon/call-center.png" width="20"
        ...
        <div class="container">
            ...
            <div class="container-fluid pt-3 pb-3">
                <center>
                    ...
                    <small class="text-dark mb-1 "></i>&nbsp; LUXURY SHOP.<a href="https://discord.gg/tsUNzKh3Md" class="text-dark mb-1"><i class="fa-solid fa-triangle-exclamation fa-fade"></i>&nbsp;ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง</a></small>
                </center>
            </div>
        </div>
    </footer>
